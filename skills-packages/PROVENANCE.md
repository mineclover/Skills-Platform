...
| :--- | :--- | :--- | :--- | :--- |
| **`platform-core`** | Skills Platform Core Team | Antigravity / Open Skills | Apache-2.0 | `worktree-lifecycle-orchestrator`, `vertical-spec-documenter`, `skill-authoring-standard`, `skills-platform-guide`, `generative-ui`, `svg-authoring`, `logical-completion-core`, `logical-completion-harness`, `lch-contract-compiler`, `lch-horizontal-explorer`, `lch-obligation-ledger`, `lch-responsibility-router`, `lch-work-unit-executor`, `lch-evidence-collector`, `lch-independent-auditor`, `lch-failure-recovery`, `lch-closure-gate`, `lch-experience-consolidator`, `lch-evolution-supervisor`, `lch-teamwork-preview` (20 skills) |
