...
Detailed architectural guide for implementing the 4 core Antigravity workflow archetypes and 5 standardized loop types in custom skills.

> **Authoritative Specification**: See [Loop Types and Skill Presets Matrix](../../../../docs/guides/loop-types-and-skill-presets-matrix.md) for the complete 2-layer governance framework.
