...
- When bundling companion hooks or safety guards with a skill, read
  [references/companion-hooks.md](references/companion-hooks.md). Enforce strict Protobuf schema
  compliance on Antigravity and verify executable script permissions.
